...
<div style="display: flex; flex-wrap: wrap; gap: 24px; justify-content: center; margin: 32px 0;">
  <div style="flex: 1 1 45%; min-width: 320px; text-align: center;">
    <img src="the/greatest-1.jpg" 
         alt="Kampala landscape gradient descent metaphor" 
         style="width: 100%; height: auto; border-radius: 12px; box-shadow: 0 8px 30px rgba(0,0,0,0.25);">
    <p style="margin-top: 12px; font-style: italic; color: #666; font-size: 0.95em;">
      Landscape → UB + Error → SGD convergence
    </p>
  </div>
  
  <div style="flex: 1 1 45%; min-width: 320px; text-align: center;">
    <img src="the/greatest-2.jpg" 
         alt="Plastic-choked Nakivubo channel flowing to Lake Victoria" 
         style="width: 100%; height: auto; border-radius: 12px; box-shadow: 0 8px 30px rgba(0,0,0,0.25);">
    <p style="margin-top: 12px; font-style: italic; color: #666; font-size: 0.95em;">
...
<div style="display: flex; flex-wrap: wrap; gap: 16px; justify-content: center; margin: 40px 0;">
  <div style="flex: 1 1 22%; min-width: 220px; text-align: center;">
    <img src="the/greatest-3.jpg" 
         alt="Nakivubo channel heavy plastic pollution" 
         style="width: 100%; height: auto; border-radius: 10px; box-shadow: 0 6px 20px rgba(0,0,0,0.2);">
    <p style="margin-top: 10px; font-size: 0.9em; color: #555;">Upstream convergence</p>
  </div>
  
  <div style="flex: 1 1 22%; min-width: 220px; text-align: center;">
    <img src="the/greatest-4.jpg" 
         alt="Dark polluted water in Nakivubo channel" 
         style="width: 100%; height: auto; border-radius: 10px; box-shadow: 0 6px 20px rgba(0,0,0,0.2);">
    <p style="margin-top: 10px; font-size: 0.9em; color: #555;">Black ledger</p>
  </div>
  
  <div style="flex: 1 1 22%; min-width: 220px; text-align: center;">
    <img src="the/greatest-5.jpg" 
         alt="Plastic waste accumulation near Lake Victoria" 
         style="width: 100%; height: auto; border-radius: 10px; box-shadow: 0 6px 20px rgba(0,0,0,0.2);">
    <p style="margin-top: 10px; font-size: 0.9em; color: #555;">Downstream test set</p>
  </div>
  
  <div style="flex: 1 1 22%; min-width: 220px; text-align: center;">
    <img src="the/greatest-6.jpg" 
         alt="Kampala terrain as loss surface" 
         style="width: 100%; height: auto; border-radius: 10px; box-shadow: 0 6px 20px rgba(0,0,0,0.2);">
    <p style="margin-top: 10px; font-size: 0.9em; color: #555;">The original basin</p>
  </div>
</div>
